...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-0 z-50 mx-auto flex max-w-lg translate-y-0 flex-col gap-6 rounded-2xl border border-border bg-background/95 p-8 shadow-glow backdrop-blur-xs focus:outline-none",
        className
      )}
      {...props}
    >
